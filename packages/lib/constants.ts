...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://smileslot.co.uk";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "SmileSlot";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@smileslot.co.uk";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "SmileSlot UK Ltd";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "SmileSlot";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "SmileSlot";
...
export const LOGO = "/smileslot-logo.svg";
export const LOGO_DARK = "/smileslot-logo.svg";
export const LOGO_ICON = "/smileslot-icon.svg";
